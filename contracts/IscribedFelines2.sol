...
contract IscribedFelines2 is ERC721A, Ownable {
    uint256 private constant MAX_SUPPLY = 10;
    uint256 private constant PAID_SUMMON_PRICE = 0.000001 ether;
    ...
    function mint(uint amount) external payable returns (bool) {
        ...
        if (msg.value < PAID_SUMMON_PRICE * amount)
    ...
    function withdraw() external onlyOwner returns (bool) {
        ...
        (bool successThree, ) = _receiverThree.call{
